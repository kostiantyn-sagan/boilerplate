...
import { Guardian, People, Person, Films, Film } from '../../components';
...
export const Private: FC = () => {
    ...
    return (
        <Switch>
            ...
            <Route
                exact
                path = { `${book.root}/lectrum-react-hw-07${book.films}` }>
                <Films/>
            </Route>
            <Route path = { `${book.root}/lectrum-react-hw-07${book.film}` }>
                <Film/>
            </Route>
            <Guardian>
